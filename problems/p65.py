...
# fraction.
#
# The infinite continued fraction can be written, √2 =
# [1;(2)], (2) indicates that 2 repeats ad infinitum. In a
# similar way, √23 = [4;(1,3,1,8)].
#
# It turns out that the sequence of partial values of
# continued fractions for square roots provide the best
# rational approximations. Let us consider the convergents for
# √2. Hence the sequence of the first ten convergents for
# √2 are:
#
# 1, 3/2, 7/5, 17/12, 41/29, 99/70, 239/169, 577/408,
# 1393/985, 3363/2378, ... What is most surprising is that the
